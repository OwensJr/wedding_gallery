...
export default function ThankYouModal({ onClose }) {
  // Intentionally do not auto-dismiss; require explicit user action to close
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="bg-white rounded-2xl p-6 z-10 text-center shadow-2xl w-full max-w-sm">
        ...
        <div className="mt-2 text-sm text-gray-600">Your files have been sent to the couple. Do you want the same for your wedding? Contact us:</div>
